...
import com.android.util.rx.RetrofitFactory;

import static com.android.util.SharedPrefsUtils.BURL;
...
public class Constant {
    ...
    public final static String MQHOST = BURL + ".casanubeserver.com";
    public final static String API_HOST = "https://" + BURL + ".casanubeserver.com";
//    public final static String API_WEB = API_HOST + "/mobile/?";
    ...
    public static String IMAGE_URL_BIG = API_HOST + "/casanube-file-service/casanube/file/t2/"; //图片下载
...
//        String API_WEB = RetrofitFactory.getUrl() + "/mobileMeasure/?";
////        String API_WEB = RetrofitFactory.getUrl() + "/mobile/?";
//        return API_WEB;
//    }
    ...
    public final static int DEVICE_TYPE_CHOL = 12;
    ...
    public final static int DEVICE_TYPE_PHOTO_FOOT = 14; // 足部拍照　
    public final static int DEVICE_TYPE_FOOT_FEEL = 13; // 足感
