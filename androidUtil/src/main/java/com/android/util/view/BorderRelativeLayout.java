...
public class BorderRelativeLayout extends RelativeLayout {
    ...
    public BorderRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        selectColor = ta.getColor(R.styleable.BorderTextView_contentBackColor,context.getResources().getColor(R.color.bgGreenShadowColor));
...
//        }
    ...
    public BorderRelativeLayout setContentColor(int contentColor) {
