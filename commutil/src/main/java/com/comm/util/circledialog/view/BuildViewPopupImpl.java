...
import com.comm.util.circledialog.BackgroundHelper;
import com.comm.util.circledialog.CircleParams;
import com.comm.util.circledialog.Controller;
import com.comm.util.circledialog.Controller.OnDialogInternalListener;
import com.comm.util.circledialog.params.DialogParams;
import com.comm.util.circledialog.params.PopupParams;
import com.comm.util.circledialog.res.drawable.TriangleDrawable;
import com.comm.util.circledialog.view.listener.ItemsView;

import java.util.LinkedList;
import java.util.Queue;

import static com.comm.util.circledialog.params.PopupParams.TRIANGLE_BOTTOM_CENTER;
import static com.comm.util.circledialog.params.PopupParams.TRIANGLE_BOTTOM_LEFT;
import static com.comm.util.circledialog.params.PopupParams.TRIANGLE_BOTTOM_RIGHT;
import static com.comm.util.circledialog.params.PopupParams.TRIANGLE_LEFT_BOTTOM;
import static com.comm.util.circledialog.params.PopupParams.TRIANGLE_LEFT_CENTER;
import static com.comm.util.circledialog.params.PopupParams.TRIANGLE_LEFT_TOP;
import static com.comm.util.circledialog.params.PopupParams.TRIANGLE_RIGHT_BOTTOM;
import static com.comm.util.circledialog.params.PopupParams.TRIANGLE_RIGHT_CENTER;
import static com.comm.util.circledialog.params.PopupParams.TRIANGLE_RIGHT_TOP;
import static com.comm.util.circledialog.params.PopupParams.TRIANGLE_TOP_CENTER;
import static com.comm.util.circledialog.params.PopupParams.TRIANGLE_TOP_LEFT;
import static com.comm.util.circledialog.params.PopupParams.TRIANGLE_TOP_RIGHT;
