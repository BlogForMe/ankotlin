...
import static com.comm.util.circledialog.res.values.CircleDimen.ITEM_TEXT_PADDING;
...
public class PopupParams extends ItemsParams {
    ...
    public static final Parcelable.Creator<PopupParams> CREATOR = new Parcelable.Creator<PopupParams>() {
        @Override
