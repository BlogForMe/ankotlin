...
import com.comm.util.window.util.Constants_LM;
import com.comm.util.window.util.SpUtil;
import com.comm.util.window.view.FloatLayout;
...
public class FloatWindowManager {
    ...
    public static void createFloatWindow(Context context) {
        ...
        wmParams.x = screenWidth-300;
        wmParams.y = screenHeight-1000;
        //设置悬浮窗口长宽数据
        Timber.i("wmParams.x    " + wmParams.x + " wmParams.y   "+wmParams.y);
