...
public final class NetworkUtil {
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        return ((ConnectivityManager) AppUtil.getApp().getSystemService(Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo();
    }
...
//        }
//        ShellAppCtxUtil.CommandResult result = ShellAppCtxUtil.execCmd(String.format("ping -c 1 %s", ip), false);
...
//    }
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager wifiManager = (WifiManager) AppUtil.getApp().getSystemService(Context.WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm = (ConnectivityManager) AppUtil.getApp()
