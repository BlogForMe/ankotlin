...
public class TextViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.bt_start).setOnClickListener(v -> {
            //            String dfa  =
            //            "rIrzbwa3JJHHfbm723cLtQtY4CzZ9Hqp9chqgRo
            //            ";
        ...
        findViewById(R.id.bt_stop).setOnClickListener(v -> {
            //            AES.test1();
            String sffNew
                = "ugyetMkRIHwHrjeoE169dB3LIji5gWPUmmsRfHERkgo4Ht+M4mBjTdl4Vy/Uq"
                + "+m9Ko20Pe4kZIYpCi0Wa0pBqpXqXxsUidEnIvd8o"
                + "+m07wmkqy1TMV3Cl01UDQMTkKhWJJUJnUFJYiQwGrjeYVQsFcoBZ28nS2ovqSILGGKPV"
                + "/eOCfpNm58B0wWPXljF4zZ9Q+mL2w3WnUhIF0UuGHrl7CAcHczIMsIqP+wOk1vcdkbLOEBu7Z"
                + "/T7iIhyhNt3Flh3vSCGvRJq28mguN4pWR29ADDL+F8HMUqJW99bjolOck=";

            //            String str = AESEncodeAllPlatform("kfafafafpppppppp",
            ...
            try {
                ...
                Timber.i(
                    "  buglyAPPId       " + buglyAPPId + " district " + district + "  host " + host
                        + "isNeedCardId " + isNeedCardId + " isOdm	" + isOdm + "	mqHost "
                        + mqHost);
