...
public class CustomViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //        String datxt = "[{\"drug_name\":\"感冒消炎片\",\"drug_num\":\"48片\",
        //        \"frequency\":\"每日1次\",\"num\":\"1包\",\"pharmacy_type\":\"皮下注射\"}]";

        //        String datxt = "[{\"drug_name\":\"参茸卫生丸\",\"drug_num\":\"9g*10丸/盒\",
        //        \"frequency\":\"每日1次\",\"num\":\"1粒\",\"pharmacy_type\":\"皮下注射\"}]";
        //        List<RecipeBean> reList = new Gson().fromJson(datxt, new
        //        TypeToken<List<RecipeBean>>() {
        //        }.getType());
