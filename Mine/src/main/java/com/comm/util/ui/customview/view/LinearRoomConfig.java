...
public class LinearRoomConfig extends LinearLayout {
    ...
    public LinearRoomConfig(Context context, AttributeSet attrs, int defStyleAttr,
                            int defStyleRes) {
    ...
    private void initView(Context context) {
        ...
        LinearLayout.LayoutParams lp1 = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
