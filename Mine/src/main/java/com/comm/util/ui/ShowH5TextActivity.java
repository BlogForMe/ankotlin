//package com.jonzhou.mineutils.ui;
//
...
//            "color=\"#FF0000\">英国</font>5月失业率、英国5月失业金申请人数、英国4月三个月ILO失业率显示，英国4
//            月三个月剔除红利的平均工资年率刷新2015年1月以来新低。英国2-4月连续3"
...
//            /></p>\n" + "  <p " +
//            "style=\"text-indent: 2em;\"><span style=\"font-family: 宋体, SimSun; font-size:
//            16px;" +
...
//            "  <p><br /></p>\n" + "  <p style=\"text-indent: 2em;\"><span style=\"font-family:
//            宋体, SimSun; " +
//            "font-size:" + " 16px;\">北京时间本周四凌晨2点美联储将公布最新利率决议及<font " +
//            "color=\"#FF0000\">政策声明</font>，预计美元在经历会议后将面临走软风险；市场广泛预期本次会议将加息25个基点至1.00%-1
//            .25%；然而，FOMC有可能在此次声明中降低核心PCE"
//            + "通胀预期，长期联邦利率中值预期也有降低的可能性，这将对加息造成压力；此外，预计本次会议将对缩减资产负债表计划有所置评。</span></p>\n" + "
//            <p><br /></p>\n" + "  "
//            + "<p " + "style=\"text-indent: 2em;\"><img src=\"http://www.gfxa" + "" + "" + "" +
//            "" + "" + "" + "" +
//            "" + ".com/upload/image/20170614/6363305821523119573565195.png\" title=\"\"
//            /></p>\n" + "  <p " +
//            "style=\"text-indent: 2em;\"><span style=\"font-family: 宋体, SimSun; font-size:
//            16px;" +
//            "\">支撑：1260——1255——1247 阻力：1273——1281</span></p>\n" + "  <p style=\"text-indent:
//            2em;\"><span " +
//            "style=\"font-family: 宋体, SimSun; font-size: 16px;\">交易策略：现货黄金现价1268
//            .30，日内交易建议如下：</span></p>\n" + "  <p "
//            + "style=\"text-indent: 2em;\"><span style=\"font-family: 宋体, SimSun; font-size:
//            16px;\">A：北京时间22:00之前,"
//            + "现货黄金上行至1274附近时四十分之一仓位做空，止损设1279，目标下看至1268/1265区间止盈。持仓阶段，现货黄金下破1271
//            后，建议将止损位下移至1274附近。持仓阶段，浮盈大于6" +
//            "美金时建议随机止盈。鉴于美联储利率决议影响的不确定性，此交易如触发，北京时间6月15日01:00之前建议择机离场。</span></p>\n" + "  <p
//            style=\"text-indent: " +
//            "2em;\"><span style=\"font-family: 宋体, SimSun; font-size: 16px;
//            \">B：北京时间6月15日07:00之前," +
...
//            "" + "" + "" + "" + "" + "" + "" + "" + "" + "" + " " + "font-size: " + "16px;" +
//            "\">交易策略：美元兑日元，现价报111
//            .20。明日凌晨有美联储议息会议，注意风险。加息概率极高，但是美元走势依旧疲软，不排除出现美元空头回补的现象。日内交易建议如下：</span" + "></p" +
//            "" + ">\n" + "" + "  " + "" + "" + "" + "" + "" + "" + "" + "" + "" + "" + "" + ""
//            + "" + "" + "" + "" +
//            "<p " + "style=\"text-indent: " + "2em;" + "\"><span " + "style=\"font-family: " +
//            "宋体, " + "SimSun;" +
//            "" + " " + "font-size: " + "16px;" + "\">A： " + "突破110.40做多，止损110.30，止盈110
//            .77</span></p>\n" + "  " + "<p " +
//            "" + "" + "" + "" + "" + "" + "" + "" + "" + "" + "" + "" + "" + "" +
//            "style=\"text-indent: 2em;" +
//            "\"><span " + "" + "style=\"font-family:" + " 宋体, " + "" + "SimSun; " + "font-size:
//            " + "16px;" + "\">B： " +
//            "" + "" + "" + "" + "" + "" + "" + "" + "" + "" + "" + "" + "" + "" + "" + "" + ""
//            + "" + "" + "" + "" +
//            "" + "应对加息:限价卖出挂单于110.80，止损111.20，止盈110.40</span></p>\n" + "" + "  " + "<p><br " +
//            "/></p>\n" + " " + " "
//            + "<p " + "style=\"text-indent: " + "2em;\"><span " + "style=\"font-family: 宋体, " +
//            "SimSun; " +
...
//            "title=\"\" " + "/><span" + " " + "style=\"font-family: 宋体, " + "SimSun; font-size:
//            16px;\">&nbsp; &nbsp;" +
//            "" + "" + "" + "" + "" + "" + "" + "" + " &nbsp; &nbsp;" + " " + "&nbsp; &nbsp;" +
//            " " + "" + "" + "" +
//            "" + "" + "" + "" + "" + "" + "" + "" + "" + "" + "" + "" + "&nbsp; &nbsp; &nbsp;
...
//            "" + "&nbsp;" + "</span></p>\n" + "" + "" + "  <p " + "" + "style=\"text-indent:
//            2em;" + "\"><span" + " "
//            + "style=\"font-family: " + "宋体, " + "" + "SimSun; " + "font-size: " + "16px;" +
//            "\">支撑1.2673-1.2600 " +
...
//            "\">交易策略：如图欧元兑美元四小时图所示，现价报1.2753，欧元轴心点为1.2714，中枢区间为1.2698—1.2730" +
//            "，日内交易建议如下：</span></p>\n" + "  " +
...
//     */
//    private void findKeyAndSetEvent(SpannableString spannableString, String tempSplitedStr,
//    final String keyStr,
//                                    int preEndIndex) {
...
//                    //点击事件弹窗+请求服务器数据
//                    Toast.makeText(ShowH5TextActivity.this, "点我干嘛？关键字：" + keyStr, Toast
//                    .LENGTH_SHORT).show();
//                }
//
//                @Override
...
// 这样的话，非第一次出现的只会将第一个字符加上超链接
//
//            tempSplitedStr = tempSplitedStr.substring(endIndex + 1);  //截取字符串，+1
//            表示从关键词后面截取，不含关键字；不加1 的话从关键词最后一个字开始截取
