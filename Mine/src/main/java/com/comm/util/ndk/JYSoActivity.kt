...
//                                deBean?.let { it ->
//                                    if (it.isCheckGls) {
//                                        activity?.tv_show?.text =
//                                            (decimalTwoPlace(it.dataValue / 18.0)).toString()
//                                    } else {
//                                        activity?.tv_show?.text =
//                                            "高压 ${deBean.pressureHighValue} mmHg  ,低压 ${deBean.pressureLowValue} mmHg, 脉搏${deBean.jumpValue}  "
//                                    }
//                                }
//                            }
//                        }
...
//                                "226" -> {
//                                    activity?.tv_show?.text =
//                                        dataCheck?.substring(dataCheck.length - 4, dataCheck.length)
//                                            ?.toInt()?.div(10.0).toString() + "mmol/L"
//                                }
//                            }
//                        }
//                    }
