...
public class RestartBleActivity extends AppCompatActivity
    implements FireMissilesDialogFragment.IConfirmListener {
                ...
                if (action.equals(BluetoothAdapter.ACTION_STATE_CHANGED)) {
                    ...
                    switch (state) {
                        case BluetoothAdapter.STATE_OFF:
                            Toast.makeText(RestartBleActivity.this, "关闭蓝牙", Toast.LENGTH_SHORT)
                                .show();
                            mHandler.sendEmptyMessageDelayed(0, 1500);
                            break;
                        case BluetoothAdapter.STATE_ON:
                            Toast.makeText(RestartBleActivity.this, "打开蓝牙", Toast.LENGTH_SHORT)
                                .show();
                            break;
                        case BluetoothAdapter.STATE_TURNING_ON:
                            Toast.makeText(RestartBleActivity.this, "蓝牙正在打开中", Toast.LENGTH_SHORT)
                                .show();
                            break;
                        case BluetoothAdapter.STATE_TURNING_OFF:
                            Toast.makeText(RestartBleActivity.this, "蓝牙正在关闭中", Toast.LENGTH_SHORT)
                                .show();
                            break;
                    }
                }
