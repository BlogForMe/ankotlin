...
//        @Override
//        public void onFirstRemoteVideoDecoded(final int uid, int width, int height, int
//        elapsed) { //  远端视频接收解码回调
...
//        }
//        mContext = context;
////        View partialLayout = LayoutInflater.from(context).inflate(R.layout
// .partial_camera_agroa, null);
...
//        mRtcEngine.setupLocalVideo(new VideoCanvas(mLocalView, VideoCanvas.RENDER_MODE_HIDDEN,
//        0));
//    }
//
...
//            return;
//        }
//        mRtcEngine.setupRemoteVideo(new VideoCanvas(remoteVideoView, VideoCanvas
//        .RENDER_MODE_FIT, uid));
