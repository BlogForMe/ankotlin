...
class DialKgView @JvmOverloads constructor(
...
//        canvas?.drawLine(0f,0f,0f,500f,mLinePaint)
        ...
        do {
            ...
            if (line % 4 == 0) {
                canvas?.drawLine(
                    startX, startY, endx, endY, mDialPaint
                )
                ...
                canvas?.drawText(
                    kgText,
                    cos(angle).toFloat() * (mRadius - 70) - txtWidth / 2,
                    sin(angle).toFloat() * (mRadius - 70) + txtHeight / 2,
                    mDialPaint
                )

            } else {
                canvas?.drawLine(
                    startX, startY, endx, endY, mLinePaint
                )
            }
            trangel += 7.5
