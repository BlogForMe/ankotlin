...
import com.android.util.window.util.DensityUtil;
...
public class SectionDecoration extends RecyclerView.ItemDecoration {
    ...
    public SectionDecoration(List<String> dataList, Context context,
        ...
        textPaint.setTextSize(DensityUtil.INSTANCE.dip2px(context, 14f));
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            //            c.drawText(textLine, left + 2 * alignBottom, textY - alignBottom,
            //            textPaint);
