...
import com.android.parth.FileUriUtils
import com.android.parth.FileUtil
        ...
        registerForActivityResult(ActivityResultContracts.OpenDocument()) { uri ->
            if (uri != null) {
                ...
                if (file != null) {
                    ...
                    img_pick.setImageResource(R.drawable.ic_menu_camera)
                    Toast.makeText(this, "This file format is not supported", Toast.LENGTH_SHORT)
                        .show()
                }
