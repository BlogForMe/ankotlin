...
public class StringUtil {
    ...
    // business action
    public final static String ACTION_CHARACTER_NOTIFICATION
        = "com.example.bluetooth.le.notification.success";
    ...
    public static String getCheckDateConclusion(String mealStatus, Double dataValue,
                                                int timeInterval) {
        String conclusion = "";
    ...
    public static String getUnitText(String color, String unit) {
        return "<font color=" + color + "><small><small><small>" + unit
