...
public class GsonUtil {
    ...
    public static String mapToGson(Map<String, Object> map) {
        ...
        //            map.put("sessionId",CertificationEntrance.generateDynamicTokenToApp
        //            (mSessionId));
        //        }
    ...
    //        String mSessionId = String.valueOf(SharedPreferencesUtils.getParam(AppCtxUtil
    //        .getApp(), SharedPreferencesUtils.DOC_SESSION_ID, ""));
