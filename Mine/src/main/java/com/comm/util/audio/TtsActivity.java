...
import com.comm.util.audio.tts.SharedData;
...
public class TtsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //                        Toast.makeText(MainActivity.this, "select = " + curLang, Toast
        //                        .LENGTH_SHORT).show();
        //                    }
        //
        //                    @Override
    ...
    public void openAudioFile(View view) {
        ...
        Log.i(TAG,
            "选择语言: " + choosedLanguage + "--" + SharedData.languageList.get(choosedLanguage));
        //mSpeech.setAudioAttributes(new AudioAttributes());
        // mSpeech.setVoice(new Voice(null,Locale.US,Voice.QUALITY_HIGH,Voice.LATENCY_NORMAL,
        // false,null));
        ...
        if (TextUtils.isEmpty(tempStr)) {
            tempStr = "深圳市家云智能科技有限公司，成立于2014年，总部位于深圳南山科技园，公司专注于物联网\n" +
                "智慧医疗和远程通信领域的研究，公司集研发、销售和服务于一体，拥有一支以科技创新为己任，\n" +
                "致力于打造中国物联网行业为领军人物的研发和销售团队。";
        }
    ...
    public void saveAudioFile(View view) {
        ...
        Log.i(TAG,
            "saveAudioFile: " + "/mnt/sdcard/" + new Date().toString().replace(" ", "_").trim()
                + ".wav" + "文件保存成功");
    ...
    private class TTSListener implements OnInitListener {
        ...
        public void onInit(int status) {
            ...
            if (status == TextToSpeech.SUCCESS) {
                ...
                //                if ((supported != TextToSpeech.LANG_AVAILABLE) && (supported !=
                //                TextToSpeech.LANG_COUNTRY_AVAILABLE)) {
                //                    Toast.makeText(MainActivity.this, "不支持当前语言！", Toast
                //                    .LENGTH_SHORT).show();
