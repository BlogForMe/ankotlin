...
public class AudioActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        findViewById(R.id.bt_big).setOnClickListener(v -> {
            //最大音量
            //            int maxVolume = mAudioManager.getStreamMaxVolume(AudioManager
            //            .STREAM_MUSIC);
            //            //当前音量
            //            int currentVolume = mAudioManager.getStreamVolume(AudioManager
            //            .STREAM_MUSIC);
            //            Timber.i("maxVolue  " + maxVolume   + "  currentVolume  " +
            //            currentVolume);
