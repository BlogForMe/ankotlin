...
public class ColorArcProgressBar extends View {
    ...
    private final boolean isShowCurrentSpeed = true;
    private int mWidth;
    private int mHeight;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int height = (int)(2 * longdegree + progressWidth + diameter
            + 2 * DEGREE_PROGRESS_DISTANCE);
    ...
    protected void onDraw(Canvas canvas) {
            ...
            for (int i = 0; i < 40; i++) {
                ...
                if (i % 5 == 0) {
                    ...
                    canvas.drawLine(centerX,
                        ...
                        centerX,
                        centerY - diameter / 2 - progressWidth / 2 - DEGREE_PROGRESS_DISTANCE
                            - (longdegree - shortdegree) / 2 - shortdegree, degreePaint);
                }
        ...
        if (isNeedContent) {
            canvas.drawText(String.format("%.0f", curValues), centerX, centerY + textSize / 3,
                vTextPaint);
        }
        if (isNeedUnit) {
