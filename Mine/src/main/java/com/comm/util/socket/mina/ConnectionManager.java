...
public class ConnectionManager {
    ...
    private void init() {
        ...
        //设置协议封装解析处理
        //        mConnector.getFilterChain().addLast("protocol", new ProtocolCodecFilter(new
        //        FrameCodecFactory()));
        //设置心跳包
    ...
    public boolean connect() {
        ...
        try {
            ...
            if (mIoSession.isConnected()) {
                Timber.i("开始连接[" + mConnector.getDefaultRemoteAddress().getHostName() + ":"
                    + mConnector.getDefaultRemoteAddress().getPort() + "]成功");
            }
